...
// Alternative approach for connection, using constants
$dbc_alt = mysqli_connect(DATABASE_HOST, DATABASE_USER, DATABASE_PASSWORD, DATABASE_NAME);
if (!$dbc_alt) {
    die("Connection failed: " . mysqli_connect_error());
}
...
$q1="INSERT INTO employees (ee_email,ee_password,ee_fname,ee_lname,ee_day,ee_month,ee_year,ee_gender,ee_country,ee_city,
